...
def main():
    ...
    st.markdown("<h2 style='font-size: 10px;'>developed by S.Chatterjee and Polina Kapitanova| School of Physics and Engineering | ITMO University </h2>", unsafe_allow_html=True)
