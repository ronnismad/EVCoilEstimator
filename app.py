...
def calculate_values(Air_Gap, No_of_Turns, Metal_Shield):
    ...
    if No_of_Turns >= 5 and No_of_Turns <= 50:
        ...
        st.markdown("<h2 style='font-size: 18px;color:green;'>THE STANDALONE VERSION OFFERS MORE FUNCTIONALITY INCLUDING CURVE SCANNING. WE ARE ABLE TO MAKE A CUSTOM ONE BASED ON YOUR PARAMETERS. PLEASE CONTACT US.</h2>", unsafe_allow_html=True)
