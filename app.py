...
def main():
    ...
    st.markdown("<h2 style='font-size: 16px;color:green;'>Conforms to the SAE J2953_202010 Standard (https://www.sae.org/standards/content/j2954_202010/)E</h2>", unsafe_allow_html=True)
