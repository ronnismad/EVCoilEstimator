...
def main():
    ...
    st.markdown("<h2 style='font-size: 10px;'>dTERMS OF USE: This application provides estimated results, which may vary depending on several parameters that are not in control of the developer. We do not guarantee 100% accuracy.</h2>", unsafe_allow_html=True)
